// This is the main page for the trips listing
// It will be used to display the list of trips
...
import building from '../../public/img/Tower-building.png'
  ...
  return (
    <>
       <div className='w-[1280px] h-[1676px] border-0 bg-[#FFFFFF]'>
        {/* <div className='w-[1280px] h-[83px] border border-[#BBBBBB] bg-[#F1F0F0]'> */}
            {/* <div className="flex space-x-[-77px] relative  ">
                <Image className='absolute top-[6px] left-[10px] w-[174px] h-[72px]' src={trippers1} alt="" />
                <Image className='absolute left-[143px] h-[46px] w-[236px] mt-6' src={trippers2} alt=""/>
            </div> */}
            {/* <div className= "space-x-8 text-[#020064] font-semibold absolute top-7 text-xl left-95">
                <span>Hotels</span>
                <span>Flights</span>
                <span>Events</span>
                <span>Tourism</span>
                <span>Account</span>
                <button className="w-[116px] h-[41px] bg-black text-white ml-40 text-[15px] rounded-full">Book now</button>
            </div> */}
        {/* </div> */}
        ...
        <div className='w-[1052px] h-[919px] absolute top-[757px] left-[83px] bg-[#D9D9D9]'>
            <Image src={rec} alt="" />
            <span className='font-bold text-white text-2xl absolute top-5 left-15'>December 2025 <span className='font-light'>Top 50 Tours</span></span>
