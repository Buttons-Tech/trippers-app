...
const Contactus = () => {
  return (
   <>
        ...
        <div className="flex">
            <Image src={phone} className="absolute top-8 left-15 h-[95.87px] w-[83.87px]" alt="image" />
            <div>
                ...
                <Image src={mail} className="h-[69px] w-[95px] absolute top-6 left-125" alt="image" />
        ...
        <div className="relative">
            <div className="flex">
                    <Image src={point} className="h-[48.38px] w-[48.38px] absolute bottom-0 right-68 " alt="image" />
            ...
            <div className="absolute top-8 right-15 gap-8 flex flex-row ">
                    <Image src={facebook} className="h-[50px] w-[50px]" alt="image" />
                    <Image src={twitter} className="rounded-3xl h-[50px] w-[50px]" alt="image" />
                    <Image src={instra} className="h-[50px] w-[50px]" alt="image" />
                    <Image src={indeed} className=" h-[50px] w-[50px]" alt="image" />
            </div>
        </div>
    </div>
   </>
