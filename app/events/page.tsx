// This is the main page for the events listing
// It will be used to display the list of events
...
import building from '../../public/img/hangout.png'
    ...
    <>
       <div className='w-[1280px] h-[1676px] border-0 bg-[#FFFFFF]'>
              ...
              <div className='w-[1052px] h-[919px] absolute top-[757px] left-[83px] bg-[#D9D9D9]'>
                  <Image src={rec} alt="" />
                  <span className='font-bold text-white text-2xl absolute top-5 left-15'>December 2025 <span className='font-light'>Events</span></span>
